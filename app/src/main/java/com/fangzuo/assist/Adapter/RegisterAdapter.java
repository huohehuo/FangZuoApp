...
public class RegisterAdapter extends RecyclerArrayAdapter<RegisterBean> {
...
//        }
    ...
    class MarkHolder extends BaseViewHolder<RegisterBean> {
        ...
        public void setData(RegisterBean data) {
            super.setData(data);
            tv_model1.setText(data.Register_code);
            tv_model2.setText(data.val1);
        }
    }
